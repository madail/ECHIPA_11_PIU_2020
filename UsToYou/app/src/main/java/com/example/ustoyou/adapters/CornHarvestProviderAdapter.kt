...
class CornHarvestProviderAdapter (private val context : Context, private var providers : ArrayList<Provider>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, viewGroupParent: ViewGroup?): View {
        ...
        price.text = "Price: " + providers[position].price.toString() + " RON/AR"
