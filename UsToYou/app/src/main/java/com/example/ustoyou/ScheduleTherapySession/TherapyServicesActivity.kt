...
import com.example.ustoyou.model.TherapyServices
import com.example.ustoyou.payment.PaymentDetailsActivity
import com.google.android.material.navigation.NavigationView

class TherapyServicesActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener{
    private lateinit var drawerLayout: DrawerLayout
    private lateinit var actionBarDrawerToggle: ActionBarDrawerToggle

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_therapy_services)
        ...
        supportActionBar?.title = "Therapy Services"
